...
},{"nanobar":"nanobar","riot-routehandler":"riot-routehandler","typeshave":"typeshave"}],4:[function(require,module,exports){
...
riot.tag('app-main', '<div id="content-wrapper"> <div class="mui--appbar-height"></div> <div class="mui-container-fluid" id="content"> <div class="mui-row"> <div class="mui-panel"> <routehandler></routehandler> </div> </div> </div> </div>', function(opts) {var createPageFromCollection, createPageFromLink, self;

self = this;

createPageFromLink = function(config, page) {
  if (page.target !== void 0 || (page.tag == null) || (page.route == null)) {
    return;
  }
  config.routes.push({
    route: page.route,
...
this.setupPages = function(config) {
  var fn, i, j, k, menuitem, p, pages, subitem;
  pages = [];
...
},{"_process":1,"path-to-regexp":8}],8:[function(require,module,exports){
...
},{"./lib/validator":15}],12:[function(require,module,exports){
"use strict"
...
},{"./formats":12,"./types":13}],15:[function(require,module,exports){
"use strict";
 ...
 * @api public
 */
function validatorFactory(schema, data, cfg) {
    var validator = Object.create(proto);
    cfg = cfg || {};
    cfg.removeExtraNodes = false || cfg.removeExtraNodes;
    validator.cfg = cfg;
    validator.init();
    validator.visit({ root: schema }, { root: data });
...
},{"./validate":14}],"domready":[function(require,module,exports){
/*!
...
},{"page":7}],"typeshave":[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var clone, tjv;
...
},{"tiny-json-validator":11}]},{},[10,5,6,4,3,2]);
