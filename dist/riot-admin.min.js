...
},{"micromustache":4}],4:[function(require,module,exports){
...
},{"nanobar":"nanobar","notification-fallback":11,"riot-routehandler":"riot-routehandler","typeshave":"typeshave"}],8:[function(require,module,exports){
...
riot.tag('app-main', '<div id="content-wrapper"> <div class="mui--appbar-height"></div> <div class="mui-container-fluid" id="content"> <div class="mui-row"> <div class="mui-panel"> <routehandler id="router"></routerhandler> </div> </div> </div> </div>', function(opts) {var jfn, self;
...
this.createPageFromCollection = function(page) {
  riot.router(page.href, function(ctx, next) {
...
this.setupPages = function() {
  var fn, k, len, p, pages;
  pages = this.getItems("collection");
  fn = function(page) {
    if (page.type === 'collection') {
      return self.createPageFromCollection(page);
    }
  };
...
riot.tag('collection', '<collection-header></collection-header> <table id="{ opts.id }" class="mui-table mui-table--bordered"> <thead> <tr > <th each="{ colkey, colval in rows[0] }" >{ colkey }</th> </tr> </thead> <tbody> <tr each="{ row in rows }" > <td each="{ colkey, colval in row }">{ colval }</td> </tr> </tbody> </table>', function(opts) {var EL, self;
...
riot.tag('gauge', '<div id="x" class="gauge-container"> <div id="a" class="gauge-a"></div> <div id="b" class="gauge-b"></div> <div id="c" class="gauge-c"></div> <div id="data" class="gauge-data"> </div> </div>', function(opts) {var me;
...
this.decrease = function() {
  if (me.val > me.valDesired) {
    me.val -= -(me.data.innerHTML = Math.round(me.val / me.ratio) + me.postfix);
    return me.increase();
  }
};
...
this.setSize = function(type) {
  ...
  return this.data.className = "gauge-data-" + type;
};
...
riot.tag('app-modal', '<div id="content" style="display:none"> <div class="mui-container"> <div class="mui-row"> <div class="mui-col-md-12"> <h1>{ this.title }</h1> </div> </div> <raw content="{ html }"></raw> </div> </div>', function(opts) {this.overlay;
...
riot.tag('raw', '<span></span>', function(opts) {this.on('update', function() {
  return this.root.innerHTML = opts.content;
});

});

},{"jsonschema2form-nested":2,"jsonschema2form-nested/themes/mui.js":5}],9:[function(require,module,exports){
(function() {
...
},{"_process":1,"path-to-regexp":16}],16:[function(require,module,exports){
...
},{"page":15}],"typeshave":[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var clone;
