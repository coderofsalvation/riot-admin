...
(function() {
    var cssContent = '/**  * Body CSS  */  html, body {   height: 100%;   background-color: #eee; }  html, body, input, textarea, buttons {   -webkit-font-smoothing: antialiased;   -moz-osx-font-smoothing: grayscale;   text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.004); }   /**  * Layout CSS  */  #header {   position: fixed;   top: 0;   right: 0;   left: 0;   z-index: 2;   transition: left 0.2s; }  #sidedrawer {   position: fixed;   top: 0;   bottom: 0;   width: 200px;   left: -200px;   overflow: auto;   z-index: 2;   background-color: #fff;   transition: left 0.2s; }  #content-wrapper {   background-color:#FFF;   min-height: 100%;   overflow-x: hidden;   margin-left: 0px;   text-align: left;    transition: margin-left 0.2s;   -webkit-transition: margin-left 0.2s;   -moz-transition: margin-left 0.2s;   -ms-transition: margin-left 0.2s;   -o-transition: margin-left 0.2s;    /* sticky bottom */   margin-bottom: -160px;   padding-bottom: 160px; }  #footer {   height: 160px;   margin-left: 0px;   transition: margin-left 0.2s; }  @media (min-width: 768px) {   #header {     left: 200px;     transition: left 0.2s;   }      #sidedrawer {     left: 0;     transition: left 0.2s;   }      #content-wrapper {     margin-left: 200px;     transition: margin-left 0.2s;   }      #footer {     margin-left: 200px;     transition: margin-left 0.2s;   }      body.hide-sidedrawer #header {     left: 0;   }      body.hide-sidedrawer #sidedrawer {     left: -200px;   }      body.hide-sidedrawer #content-wrapper {     margin-left: 0;   }      body.hide-sidedrawer #footer {     margin-left: 0;   }    .hide-small {     display:none;   } }  .center {   text-align: center }   /**  * Toggle Sidedrawer  */  #sidedrawer.active {   left: 0;   transition: left 0.2s; }   /**  * Header CSS  */  .sidedrawer-toggle {   color: #fff;   cursor: pointer;   font-size: 20px;   line-height: 20px;   margin-right: 10px; }  .sidedrawer-toggle:hover {   color: #fff;   text-decoration: none; }  #sidedrawer-toggler{   line-height:60px; }   /**  * Sidedrawer CSS  */  #sidedrawer-brand {   padding-left: 20px; }  #sidedrawer ul {   list-style: none; }  #sidedrawer > ul {   padding-left: 0px; }  #sidedrawer strong {   display: block;   padding: 15px 22px;   cursor: pointer;   color: #2196F3; }  #sidedrawer strong:hover {   background-color: #E7E7E7; }  #sidedrawer ul > li > ul {   cursor: pointer;   -webkit-transition: max-height 0.6s ease-out;   -moz-transition: max-height 0.6s ease-out;   -o-transition: max-height 0.6s ease-out;   transition: max-height 0.6s ease-out;   overflow: hidden;   max-height:0em; }  #sidedrawer ul > li > ul.expand {     max-height: 20em; }  #sidedrawer strong + ul > li {   padding: 6px 0px; }   /**  * Footer CSS  */  #footer {   background-color: #0288D1;   color: #fff; }  #footer a {   color: #fff;   text-decoration: underline; }  /* fix */ #sidedrawer_toggle {   line-height:60px; }  /* animations */  .fadein { opacity:1; -webkit-animation: fadein 0.4s; /* Safari, Chrome and Opera > 0.42.0.4 */    -moz-animation: fadein 0.4s; /* Firefox < 0.46 */     -ms-animation: fadein 0.4s; /* Internet Explorer */      -o-animation: fadein 0.4s; /* Opera < 0.42.0.4 */         animation: fadein 0.4s; }  .fadeout { opacity:0; -webkit-animation: fadeout 0.4s; /* Safari, Chrome and Opera > 0.42.0.4 */    -moz-animation: fadeout 0.4s; /* Firefox < 0.46 */     -ms-animation: fadeout 0.4s; /* Internet Explorer */      -o-animation: fadeout 0.4s; /* Opera < 0.42.0.4 */         animation: fadeout 0.4s; }  @keyframes fadein {     from { opacity: 0; }     to   { opacity: 1; } }  /* Firefox < 16 */ @-moz-keyframes fadein {     from { opacity: 0; }     to   { opacity: 1; } }  /* Safari, Chrome and Opera > 12.1 */ @-webkit-keyframes fadein {     from { opacity: 0; }     to   { opacity: 1; } }  /* Internet Explorer */ @-ms-keyframes fadein {     from { opacity: 0; }     to   { opacity: 1; } }  /* Opera < 12.1 */ @-o-keyframes fadein {     from { opacity: 0; }     to   { opacity: 1; } }   @keyframes fadeout {     from { opacity: 1; }     to   { opacity: 0; } }  /* Firefox < 16 */ @-moz-keyframes fadeout {     from { opacity: 1; }     to   { opacity: 0; } }  /* Safari, Chrome and Opera > 12.1 */ @-webkit-keyframes fadeout {     from { opacity: 1; }     to   { opacity: 0; } }  /* Internet Explorer */ @-ms-keyframes fadeout {     from { opacity: 1; }     to   { opacity: 0; } }  /* Opera < 12.1 */ @-o-keyframes fadeout {     from { opacity: 1; }     to   { opacity: 0; } }  /* CSS3 Gauges */  .gauge-container-big {   display: inline-block;   width: 400px;   height: 200px;   margin-left: 200px;   margin-top: 100px;   position: relative;   overflow: hidden;   text-align: center;   transform: translate(-50%, -50%); }  .gauge-a-big {   z-index: 1;   position: absolute;   background-color: rgba(127,177,255,0.1);   width: 400px;   height: 200px;   top: 0%;   border-radius: 250px 250px 0px 0px; }  .gauge-b-big {   z-index: 3;   position: absolute;   background-color: #222;   width: 250px;   height: 125px;   top: 75px;   margin-left: 75px;   margin-right: auto;   border-radius: 250px 250px 0px 0px; }  .gauge-c-big {   z-index: 2;   position: absolute;   background-color: rgba(0,127,254,0.5);   width: 400px;   height: 200px;   top: 200px;   margin-left: auto;   margin-right: auto;   border-radius: 0px 0px 200px 200px;   transform-origin: center top;   transition: all 1.3s ease-in-out; }  .gauge-container-big:hover .gauge-data-big { color: rgba(255,255,255,1); }  .gauge-data-big {   z-index: 4;   color: rgba(255,255,255,.66);   font-size: 1.5em;   line-height: 125px;   position: absolute;   width: 400px;   height: 125px;   top: 90px;   margin-left: auto;   margin-right: auto;   transition: all 1s ease-out; }  .gauge-container-small {   width: 200px;   height: 100px;   margin-left: 100px;   margin-top: 50px;   position: relative;   overflow: hidden;   text-align: center;   transform: translate(-50%, -50%); }  .gauge-a-small {   z-index: 1;   position: absolute;   background-color: rgba(127,177,255,0.1);   width: 200px;   height: 100px;   top: 0%;   border-radius: 125px 125px 0px 0px; }  .gauge-b-small {   z-index: 3;   position: absolute;   background-color: #222;   width: 125px;   height: 75px;   top: 37px;   margin-left: 37px;   margin-right: auto;   border-radius: 125px 125px 0px 0px; }  .gauge-c-small {   z-index: 2;   position: absolute;   background-color: rgba(0,127,254,0.5);   width: 200px;   height: 100px;   top: 100px;   margin-left: auto;   margin-right: auto;   border-radius: 0px 0px 100px 100px;   transform-origin: center top;   transition: all 1.3s ease-in-out; }  .gauge-container-small:hover .gauge-data-small { color: rgba(255,255,255,1); }  .gauge-data-small {   display: inline-block;   z-index: 4;   color: rgba(255,255,255,.66);   font-size: 1.0em;   line-height: 75px;   position: relative;   width: 200px;   height: 75px;   top: 45px;   margin-left: auto;   margin-right: auto;   transition: all 1s ease-out; }  .gauge-spacer {   display:block;  }  .gauge-small {   display:inline-block;   overflow: hidden;   height:100px;   width: 220px; }  .gauge-big {   display:inline-block;   overflow: hidden;   height:200px;   width: 440px; } ';
...
},{"nanobar":"nanobar","notification-fallback":11,"riot-routehandler":"riot-routehandler","typeshave":"typeshave"}],3:[function(require,module,exports){
riot.tag2('app-footer', '<footer id="footer"> <div class="mui-container-fluid"> <br> <raw content="{opts.footer.slogan}"></raw> </div> </footer>', '', '', function(opts) {
}, '{ }');


riot.tag2('app-header', '<header id="header"> <div class="mui-appbar mui--appbar-line-height"> <div class="mui-container-fluid"> <a id="sidedrawer-toggler" class="sidedrawer-toggle mui--hidden-xs js-show-sidedrawer">☰</a> <a id="sidedrawer-toggler-xs" class="sidedrawer-toggle mui--visible-xs-inline-block js-show-sidedrawer">☰</a> <span class="mui--text-title mui--visible-xs-inline-block"><i class="fa {opts.project.icon}"></i>{opts.project.title}</span> </div> </header>', '', '', function(opts) {
}, '{ }');

riot.tag2('app-main', '<div id="content-wrapper"> <div class="mui--appbar-height"></div> <div class="mui-container-fluid" id="content"> <div class="mui-row"> <div class="mui-panel"> <routehandler id="router"></routerhandler> </div> </div> </div> </div>', '', '', function(opts) {
var jfn, self;
...
this.createPageFromCollection = function(page, opts) {
  console.log("create collection");
  return opts.routes.push({
    route: page.href,
    use: function(ctx, next) {
      self.router._tag.setTag(page.tag, {
        config: opts,
        page: page
      });
      page.data((function(data) {
        var i, k, len, ref, ref1, row;
        riot.mount('collection', {
          id: page.id,
          config: opts,
          dataoptions: data,
          data: data.data,
        ...
        if (((ref = page.edit) != null ? ref.schema : void 0) != null) {
          i = 0;
          ref1 = $$_('#' + page.id + ' tbody tr');
          for (k = 0, len = ref1.length; k < len; k++) {
            row = ref1[k];
            row.addEventListener('click', (function(dataitem) {
              return function(e) {
                var html;
                html = '<div class="mui-row">\n  <form id=\'form\'></form>\n</div>\n<div class="mui-row">\n  <div class="mui-col-md-12">\n    <button type=\'submit\' id="formsubmit" class=\'mui-btn mui-btn--raised\'>Save</button>';
                if (dataitem.id != null) {
                  html += "<button type='submit' id='formdelete' class='mui-btn mui-btn--raised'>Delete</button>";
                }
                html += '</div></div>';
                ...
                return $_("#formsubmit").addEventListener('click', function() {
                  self.opts.loadingbar.go(50);
                  return page.edit.onSave(jfn.toJSON($_("#form")), function(succes, msg) {
                    var n;
                    self.opts.loadingbar.go(100);
                    $_("#edit")._tag.hide();
                    n = new Notification(msg);
                    return n.leaveAfter(2000, n);
                  });
                });
              };
            })(data.data[i++]));
...
this.setupPages = function(opts) {
  var fn, k, len, p, pages;
  pages = this.getItems("collection");
  fn = function(page) {
    if (page.type === 'collection') {
      return self.createPageFromCollection(page, opts);
    }
  };
...
this.toggle = (function(_this) {
  return function() {
    _this.sidedrawer.toggleClass('active');
...
riot.tag2('collection', '<collection-header></collection-header> <table id="{opts.id}" class="mui-table mui-table--bordered"> <thead> <tr> <th each="{colkey, colval in rows[0]}">{colkey}</th> </tr> </thead> <tbody> <tr each="{row in rows}"> <td each="{colkey, colval in row}">{colval}</td> </tr> </tbody> </table>', '', '', function(opts) {
var EL, self;
...
this.load = EL.load = (function(newrows) {
...
this.on('update', function() {
  ...
  return riot.tag('rcol', '', function(opts) {
    var self;
    self = this;
    this.on('mount', function() {
...
riot.tag2('gauge', '<div id="gauge" class="gauge"> <div id="x" class="gauge-container"> <div id="a" class="gauge-a"></div> <div id="b" class="gauge-b"></div> <div id="c" class="gauge-c"></div> <div id="data" class="gauge-data"></div> </div> </div>', '', '', function(opts) {
var me;
...
this.getValue = function() {
  if (!me.hidevalue) {
    return Math.round(me.val / me.ratio);
  } else {
    return "";
  }
};
...
this.increase = function() {
  if (me.val < me.valDesired) {
    ...
    return setTimeout(me.increase, me.timeout);
  }
};
...
this.decrease = function() {
  if (me.val > me.valDesired) {
    me.val -= 0.5;
    me.data.innerHTML = me.getValue() + me.postfix;
    return setTimeout(me.decrease, me.timeout);
  }
};

this.updateRadius = function(percent) {
  var gaugepos;
  gaugepos = (0.5 / 100) * percent;
  gaugepos = String(gaugepos).substr(1, 2);
  return me.c.style.transform = 'rotate(' + gaugepos + 'turn)';
};

this.setSize = function(type) {
  var i, j, len, ref;
  this.x.className = "gauge-container-" + type;
  ref = ["a", "b", "c"];
  for (j = 0, len = ref.length; j < len; j++) {
    i = ref[j];
    this[i].className = "gauge-" + i + "-" + type;
  }
  this.data.className = "gauge-data-" + type;
  return this.gauge.className = "gauge-" + type;
};

this.on('update', function() {
  this.ratio = 100 / parseInt(opts.total);
  this.valDesired = this.ratio * parseInt(opts.value);
  this.postfix = opts.postfix;
  if (opts.hidevalue != null) {
    this.hidevalue = true;
  }
  this.setSize(opts.type);
  setTimeout(this.increase, this.timeout);
  setTimeout(this.decrease, this.timeout);
  return setTimeout(function() {
    return me.updateRadius(me.valDesired);
  }, 500);
});
});

riot.tag2('app-modal', '<div id="content" style="display:none"> <div class="mui-container"> <div class="mui-row"> <div class="mui-col-md-12"> <h1>{this.title}</h1> </div> </div> <raw content="{html}"></raw> </div> </div>', '', '', function(opts) {
this.overlay;
...
this.show = function(title, html) {
  ...
  this.overlay.style.margin = '5% auto';
  this.overlay.style.backgroundColor = '#fff';
  this.title = title;
  this.html = html;
  this.update();
  this.content.appendTo(this.overlay, true);
  return mui.overlay('on', this.overlay);
};

this.hide = function() {
  return mui.overlay('off', this.overlay);
};
...
},{"jsonschema2form-nested":5,"jsonschema2form-nested/themes/mui.js":8}],4:[function(require,module,exports){
/*!
...
(function() {
  ...
  JFN.render = function(options) {
    ...
    this.element.addEventListener('click', (function(e) {
      var container;
      var container, detail, item, p, span, target;
      detail = void 0;
      target = null;
      if (e) {
      ...
      switch (detail.action) {
        case 'add':
          container = void 0;
          item = void 0;
          if ((container = target.parentNode) && (container = container.getElementsByTagName(this.template.nestingtag))) {
...
},{"micromustache":7}],7:[function(require,module,exports){
...
},{"_process":18,"path-to-regexp":14}],14:[function(require,module,exports){
...
},{}],"domready":[function(require,module,exports){
/*!
...
},{}],"riot-routehandler":[function(require,module,exports){
...
},{"page":13}],"typeshave":[function(require,module,exports){
